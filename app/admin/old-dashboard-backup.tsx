...
export default function AdminMainMenu() {
  ...
  useEffect(() => {
    ...
    console.log('Admin session check:', { adminUser: !!adminUser, adminSession })
    
    // 認証チェック
    if (!adminUser || !adminSession) {
      console.log('セッションが無いためログインページにリダイレクト')
      ...
      <div className="bg-white shadow">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center py-6">
            <div>
              <h1 className="text-3xl font-bold text-gray-900">管理画面 <span className="text-lg text-gray-600">(全ユーザー管理・Ecfront2連携)</span></h1>
              {currentAdmin && (
